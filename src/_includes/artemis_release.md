...
[Release Notes](release-notes-{{include.release.version}}) | [Git Report](commit-report-{{include.release.version}}) | [Documentation:]({{docs_prefix}}/{{docs_version}}) [HTML]({{docs_prefix}}/{{docs_version}}) / [PDF]({{docs_prefix}}/{{docs_version}}/book.pdf) |{% if include.examples_link %} [Examples](https://github.com/apache/artemis-examples/) |{% endif %} [Docker](https://hub.docker.com/r/apache/{{component_dir}}/tags) | Java compatibility: **{{include.release.java_version}}**
